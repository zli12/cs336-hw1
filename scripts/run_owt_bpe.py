...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train OpenWebText BPE and serialize vocab/merges.")
    parser.add_argument(
        "--input",
        type=Path,
        default=Path("data/owt_train.txt"),
        help="Path to OpenWebText train file.",
    )
    ...
    parser.add_argument(
        "--out-merges",
        type=Path,
        default=Path("data/owt-bpe-32k-merges.txt"),
